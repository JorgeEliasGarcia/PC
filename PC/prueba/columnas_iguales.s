...
size=4 # bytes que ocupa un entero
    .data
mat:   .word   100, 101, 100, 103, 104
       .word   120, 121, 120, 123, 124
       .word   140, 141, 140, 143, 144
       .word   160, 161, 160, 163, 164
       .word   180, 181, 180, 183, 184 
       .word   200, 201, 200, 203, 204 
       

nfil:   .word   6 # nuemro de filas de la matriz
ncol:   .word   5 # numero de columnas de la matriz
...
x:          .asciiz " x "
msg_fin:    .asciiz "\nFin del programa.\n"
prmera_col: .asciiz "\nIntroduzca el número de la primera columna.\n"
sgda_col:   .asciiz "\nIntroduzca el número de la segunda columna.\n"
...
main:
  ...
  etiqueta_do: 
    ...
    mostrar_menu: 
      ...
      beq $t3, 6, prev_mi_funcion_simple
      beq $t3, 7, comparar_col_prev
  ...
  comparar_col_prev: 
    ...
    li $v0, 5
    syscall
    move $t0, $v0 #$t0 = Índice de la primera columna a comparar
    ...
    li $v0, 5
    syscall
    move $t1, $v0  #$t1 = Índice segunda columna. 

    mul $t0, $t0, size
    mul $t1, $t1, size 
    
    la $a1, mat 
    add $a1, $a1, $t0  #$a1 = Primer elemento primera columna a comparar. 

    la $a2, mat
    add $a2, $a2, $t1  #$a2 = Primer elemento de la segunda columna a comparar. 

    lw $t0, ncol
    mul $t0, $t0, size
    move $a3, $t0   #$a3 = Distancia entre elementos de la misma columna. 

    lw $a0, nfil  #$a0 = Número de filas. 
...
comparar_col: 
#Caso Base = Número de elementos restantes en la pila sea igual a cero 
  bgtz $a0, casogeneral
  li $v0, 1 #Vslor por defecto en caso de solo haber un elemnto
  jr $ra
  ...
  general:  
    ...
    addi $a1, 8   #Apuntamos a los siguientes
